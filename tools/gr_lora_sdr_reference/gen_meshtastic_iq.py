...
class TxFlowgraph(gr.top_block):
    ...
    def __init__(self, frame_bytes: bytes, sf: int, cr: int, bw: int,
        ...
        # File sinks for testing
        outdir = os.path.dirname(out_path)
        self.tap_gray = blocks.file_sink(gr.sizeof_int, f"{outdir}/meshtastic_test_06_gray.bin", False)
        self.tap_gray.set_unbuffered(False)
...
def main():
    ...
    ap.add_argument("--out", default="rust_core/tests/fixtures/meshtastic_test.cf32")
    ...
    print(f"wrote gray symbols to {os.path.dirname(args.out)}/meshtastic_test_06_gray.bin")
